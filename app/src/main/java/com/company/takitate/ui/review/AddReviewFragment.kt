...
class AddReviewFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        db = Room.databaseBuilder(
            requireContext(), MyDatabase::class.java, "room-database"
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.pre_fragment_add_review, container, false
        ) // bindingクラスを生成
...
//    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: String, param2: String) = AddReviewFragment().apply {
