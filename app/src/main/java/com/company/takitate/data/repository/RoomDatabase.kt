...
import com.company.takitate.domain.entity.DateTimeConverter
import com.company.takitate.domain.entity.Review
import com.company.takitate.domain.entity.ReviewDao
import com.company.takitate.domain.entity.Reviewer
import com.company.takitate.domain.entity.ReviewerDao
    ...
    companion object {
        ...
        val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                database.execSQL(
                    "CREATE TABLE `reviews_new` (`review_id` TEXT NOT NULL, `reviewer_id` TEXT NOT NULL, `restaurant_id` TEXT NOT NULL, `comment` TEXT NOT NULL, `title` TEXT NOT NULL, `datetime` INTEGER NOT NULL," +
